...
public class TabMain extends TabActivity {
	...
	public static final String TAB_COMMAND_SEND = "tab-command_send";
	...
	private void initTabs() {		
		...
		mTabHost.addTab(mTabHost.newTabSpec(TAB_COMMAND_SEND)
				.setIndicator(getResources().getString(R.string.tt_commands))
				.setContent(new Intent(this, SendCommandActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP)));
