...
public class NetworkConnectivityListener {
    ...
    public static final int STATE_CONNECTED_WIFI = 1;
    public static final int STATE_CONNECTED_MOBILE = 2;
    public static final int STATE_UNCONNECTED = 3;
...
//            }
            ...
            if (noConnectivity) {
            	mConnected = STATE_UNCONNECTED;
                mState = State.NOT_CONNECTED;
            } else if (mNetworkInfo.getType() == ConnectivityManager.TYPE_WIFI){
            	mConnected = STATE_CONNECTED_WIFI;
                mState = State.CONNECTED;
            } else {
            	mConnected = STATE_CONNECTED_MOBILE;
                mState = State.CONNECTED;           	
            }
