...
if ($_GET['r']=='add'){
	...
	pageRedirect("project_fields.php?id=".$project_id);
}
...
while ($row = mysql_fetch_assoc($result)){
	...
	echo "<a href='project_fields.php?id={$row['id']}&project_id=$id&r=delete' onclick='return confirm(\"Are you sure?\");'><img src='images/delete.png' border='0' title='Delete' /></a>";
	echo "</span>\n";
...
$(document).ready(function() { 
	...
	$("#field-list").sortable({ 
		...
		update : function () { 
			...
			var url = "project_fields.php?r=order&"+order;
	...
	// inplace editor
	$('.field_column').editable("project_fields.php?r=editcol", {
		indicator : 'Saving...',
