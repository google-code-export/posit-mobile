...
public class ListFindsDialogCamera extends Dialog {
	...
	public ListFindsDialogCamera(Context context,GeoPoint _geoPoint) {
		super(context);
    ...
    private OnItemClickListener findsClickListener = new OnItemClickListener(){
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			nSD.show();
			ListFindsDialogCamera.this.dismiss();*/
			Intent i = new Intent(mContext, CameraPreview3.class);
	...
	public ListFindsDialogCamera(Context context, int theme) {
		super(context, theme);
		// TODO Auto-generated constructor stub
	}

	public ListFindsDialogCamera(Context context, boolean cancelable,
