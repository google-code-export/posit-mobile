...
/*		+ KEY_IMAGE_URI + " text, "
	...
	public boolean deleteVideos(Cursor videosQuery) {
		...
		Cursor cursor = mDb.query(VIDEO_TABLE_NAME, new String[]{KEY_VIDEO_URI}, KEY_FIND_ID + " = " + id, null, null, null, null);
	...
	public boolean deleteAudioClips(Cursor audiosQuery) {
		...
		Cursor cursor = mDb.query(AUDIO_TABLE_NAME, new String[]{KEY_AUDIO_URI}, KEY_FIND_ID + " = " + id, null, null, null, null);
		cursor.moveToFirst();
		boolean isLast = cursor.isLast();
		while (!isLast){
			String uriString = cursor.getString(0);
