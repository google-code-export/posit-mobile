...
public class Communicator {
	...
	public static int HOST_NOT_RESOLVED=2;
	...
	public static int connectionStatus(Context _context) {
	 ...
	 */
	public void sendFind (Find find) throws UnknownHostException {
	...
	public void sendMedia(int identifier, int findId, String data, String mimeType) throws UnknownHostException {
	...
	public void updateFind (Find find) throws UnknownHostException {
		HashMap<String, String> sendMap = find.getContentMap();
		cleanupOnSend(sendMap);
	 ...
	 */
	private String doHTTPPost(String Uri, HashMap<String,String> sendMap) throws UnknownHostException {
	 ...
	 */
	public List<HashMap<String,Object>> getAllRemoteFinds() throws UnknownHostException {
	...
	public void updateFindFromServer(Find find) throws UnknownHostException {
	 ...
	 * @return
	 */
	public ContentValues getRemoteFindById(long remoteFindId) throws UnknownHostException {
	 ...
	 */
	public boolean imageExistsOnServer(int imageId) throws UnknownHostException {
		HashMap<String, String> sendMap = new HashMap<String,String>();
		addRemoteIdentificationInfo(sendMap);
		String imageUrl = server +"/api/getPicture?id=" + imageId + "&authKey=" +authKey;
		String imageResponseString = doHTTPPost(imageUrl, sendMap);
	...
	public String logPoint(double lat, double lng, String imei) {
		String result = doHTTPGET("http://posit.hfoss.org/sandbox/api/logPoint?lat="+lat+"&lng="+lng+"&imei="+imei+"&expedition="+expedition);
		return result;
	}	
	
	public String logPoint(double lat, double lng,  double alt, String imei) {
		String result = doHTTPGET("http://posit.hfoss.org/sandbox/api/logPoint?lat="+lat+"&lng="+lng+"&alt="+alt+"&imei="+imei+"&expedition="+expedition);
		return result;
	}
}