...
public class PositMain extends Activity {
    ...
    public void onCreate(Bundle icicle) {
       ...
       /* SharedPreferences applicationType = getSharedPreferences ("Application",MODE_PRIVATE);
        applicationType.getString("Application Type", "Not-defined");*/
        mapViewItems();
    ...
    private void mapViewItems() {
    	...
    	viewSightingsButton.setVisibility(View.INVISIBLE);
    }
