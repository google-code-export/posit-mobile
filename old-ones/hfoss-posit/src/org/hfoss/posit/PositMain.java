...
public class PositMain extends Activity {
	...
	private static final int SERVER_ID = Menu.FIRST+4;
	public PositMain(){	}
   ...
   // 	Intent i = new Intent(this, Mapper.class);
    	Intent i = new Intent(this, NewFindSci.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, CAMERA_ID, R.string.menu_camera).setIcon(R.drawable.camera_icon_32x32);
		menu.add(0, SERVER_ID, R.string.menu_camera).setIcon(R.drawable.db_32x32);
